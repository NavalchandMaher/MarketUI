...
class ApiService {
  ...
  Future<BacktestModel> runBacktest({
    String symbol = AppConfig.defaultSymbol,
    String timeframe = AppConfig.defaultTimeframe,
    int days = 30,
  }) async {
    ...
    return BacktestModel.fromJson(json);
  }
  ...
  Future<BacktestResult?> getBestBacktest({
    String symbol = AppConfig.defaultSymbol,
    String timeframe = AppConfig.defaultTimeframe,
    int days = 30,
  }) async {
    ...
    return result.dashboard.bestStrategy;
  }
  ...
  Future<List<BacktestResult>> getBacktestResults({
    ...
    return result.dashboard.allResults;
  }
  ...
  Future<BacktestModel> refreshBacktest({
    String symbol = AppConfig.defaultSymbol,
    String timeframe = AppConfig.defaultTimeframe,
    int days = 30,
  }) async {
  ...
  Future<bool> hasBacktestHistory() async {
    final history = await getBacktestHistory();
  ...
  Future<BacktestResult?> getLatestBacktest() async {
    final history = await getBacktestHistory();
  ...
  Future<int> getTotalBacktests() async {
    final history = await getBacktestHistory();
